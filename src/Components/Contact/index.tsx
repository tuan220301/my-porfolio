                ...
                isMobile ?
                    <Box>
                        ...
                        <Box style={mobileBox as any}>
                            ...
                            <Text style={textMobile as any}>0901422185</Text>
                        </Box>
                        <Box style={mobileBox as any}>
                            <Box style={{
                                display: 'flex',
                            ...
                            <Tooltip label="Click to copy" hasArrow>
                                <Text style={textMobile as any} onClick={handleCopyEmail}>
                        ...
                        <Box style={mobileBox as any}>
                            <Box style={{
                                ...
                                {/* <Text style={textLeft}>Linkdn </Text> */}
                            </Box>
                            <Text style={textMobile as any}>
                        ...
                        <Box width={'63%'} height={'fit-content'}>
                            ...
                            <Box width={'100%'}>
                                ...
                                <Box style={{
                                    ...
                                    {!isMobile && <Box width={'100%'} height={'fit-content'} >
